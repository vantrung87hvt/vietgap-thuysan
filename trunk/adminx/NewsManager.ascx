<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NewsManager.ascx.cs" Inherits="INVI.INVINews.Admin.NewsManager" %>
...
<asp:LinkButton ID="lbtnDelete" runat="server" 
    onclick="lbtnDelete_Click">Xóa đã chọn</asp:LinkButton>|
