<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCoquancaptrenQuanly.ascx.cs" Inherits="adminx_ucCoquancaptrenQuanly" %>
<h2>
...
&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="ID:"></asp:Label><asp:TextBox
    ...
    <tr>
    <td><asp:GridView ID="grvCoquancaptren" runat="server" HeaderStyle-CssClass="GridHeader" 
        AllowPaging="True" AllowSorting="True" CssClass="Grid"
        AlternatingRowStyle-CssClass="GridAltItem" AutoGenerateColumns="False" 
        onsorting="grvCoquancaptren_Sorting" 
        onpageindexchanging="grvCoquancaptren_PageIndexChanging" 
        onselectedindexchanging="grvCoquancaptren_SelectedIndexChanging" EnableModelValidation="True" 
        >
        <Columns>
           <asp:TemplateField HeaderText="Chọn tất">
            ...
            <asp:BoundField DataField="PK_iCoquancaptrenID" HeaderText="ID" 
                SortExpression="PK_iCoquancaptrenID" ></asp:BoundField>
            <asp:BoundField DataField="sTencoquan" HeaderText="Tên" 
                SortExpression="sTencoquan" ></asp:BoundField>
