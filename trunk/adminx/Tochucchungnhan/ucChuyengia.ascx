...
<link href="../css/Grid_View.css" rel="stylesheet" type="text/css" />
            ...
            <table width="100%">
                <tr>
                    <td width="30%" colspan="2" style="width: 100%" align="center">
                        <asp:Label ID="lblInfo" runat="server" 
                            Text="Danh sách chuyên gia"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="middle" width="70%">
                        ...
                        <asp:RequiredFieldValidator ID="rqTentrinhdo" runat="server" 
                            ControlToValidate="txtHoten" ErrorMessage="*" ValidationGroup="vgGroup"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td valign="middle" width="70%">
                        ...
                        <asp:TextBox ID="txtSonamkinhnghiem" runat="server" 
                            Width="95%"></asp:TextBox>
                        
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="txtSonamkinhnghiem" ErrorMessage="*" ValidationGroup="vgGroup"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td valign="middle" width="70%">
                        ...
                        <asp:TextBox ID="txtMaso" runat="server" 
                            Width="95%"></asp:TextBox>
                        
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ControlToValidate="txtMaso" ErrorMessage="*" ValidationGroup="vgGroup"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td valign="middle" width="70%">
                        <asp:Image ID="imgAnhthe" runat="server" />
            ...
            <asp:GridView ID="grvChuyengia" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PK_iChuyengiaID" HeaderText="ID" 
                        SortExpression="PK_iChuyengiaID" />
                    <asp:BoundField DataField="sHoten" HeaderText="Họ tên" 
                        SortExpression="sHoten" >
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                    <asp:BoundField DataField="sMaso" HeaderText="Mã số" 
                        SortExpression="sMaso" >
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                    <asp:BoundField DataField="iNamkinhnghiem" HeaderText="Kinh nghiệm (năm)" 
                        SortExpression="iNamkinhnghiem" >
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="Tổ chức chứng nhận" SortExpression="FK_iTochucchungnhan">
                        <ItemTemplate>
                            <asp:Label ID="lblTochucchungnhan" runat="server" Text='<%# Bind("FK_iTochucchungnhan") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
