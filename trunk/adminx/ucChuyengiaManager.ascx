<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucChuyengiaManager.ascx.cs"
    Inherits="uc_ucTinh" %>
...
<table style="width: 100%; margin-top: 20px; height: auto;">
    ...
    <tr>
        <td>
            <asp:GridView ID="grvChuyengia" runat="server" HeaderStyle-CssClass="GridHeader"
                AllowPaging="True" AllowSorting="True" CssClass="Grid" AlternatingRowStyle-CssClass="GridAltItem"
                AutoGenerateColumns="False" OnSorting="grvChuyengia_Sorting" OnPageIndexChanging="grvChuyengia_PageIndexChanging"
                OnSelectedIndexChanging="grvChuyengia_SelectedIndexChanging" 
