...
"ui-datepicker-days-cell-over"; this.regional = []; this.regional[""] = { closeText: "Done", prevText: "Prev", nextText: "Next", currentText: "Today", monthNames: ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"], monthNamesShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], dayNames: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], dayNamesShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], dayNamesMin: ["Su",
...
[{ toggle: c }, a, b, d])
    ...
    }); f.extend(f.effects, { version: "1.8.15", save: function (c, a) { for (var b = 0; b < a.length; b++) a[b] !== null && c.data("ec.storage." + a[b], c[0].style[a[b]]) }, restore: function (c, a) { for (var b = 0; b < a.length; b++) a[b] !== null && c.css(a[b], c.data("ec.storage." + a[b])) }, setMode: function (c, a) { if (a == "toggle") a = c.is(":hidden") ? "show" : "hide"; return a }, getBaseline: function (c, a) {
        var b; switch (c[0]) {
            case "top": b =
...
; (function ($, window, document) {
    $.fn.dataTableSettings = []; var _aoSettings = $.fn.dataTableSettings; $.fn.dataTableExt = {}; var _oExt = $.fn.dataTableExt; _oExt.sVersion = "1.8.1"; _oExt.sErrMode = "alert"; _oExt.iApiIndex = 0; _oExt.oApi = {}; _oExt.afnFiltering = []; _oExt.aoFeatures = []; _oExt.ofnSearch = {}; _oExt.afnSortData = []; _oExt.oStdClasses = { sPagePrevEnabled: "paginate_enabled_previous", sPagePrevDisabled: "paginate_disabled_previous", sPageNextEnabled: "paginate_enabled_next", sPageNextDisabled: "paginate_disabled_next", sPageJUINext: "", sPageJUIPrev: "", sPageButton: "paginate_button", sPageButtonActive: "paginate_active", sPageButtonStaticDisabled: "paginate_button paginate_button_disabled", sPageFirst: "first", sPagePrevious: "previous", sPageNext: "next", sPageLast: "last", sStripOdd: "odd", sStripEven: "even", sRowEmpty: "dataTables_empty", sWrapper: "dataTables_wrapper", sFilter: "dataTables_filter", sInfo: "dataTables_info", sPaging: "dataTables_paginate paging_", sLength: "dataTables_length", sProcessing: "dataTables_processing", sSortAsc: "sorting_asc", sSortDesc: "sorting_desc", sSortable: "sorting", sSortableAsc: "sorting_asc_disabled", sSortableDesc: "sorting_desc_disabled", sSortableNone: "sorting_disabled", sSortColumn: "sorting_", sSortJUIAsc: "", sSortJUIDesc: "", sSortJUI: "", sSortJUIAscAllowed: "", sSortJUIDescAllowed: "", sSortJUIWrapper: "", sSortIcon: "", sScrollWrapper: "dataTables_scroll", sScrollHead: "dataTables_scrollHead", sScrollHeadInner: "dataTables_scrollHeadInner", sScrollBody: "dataTables_scrollBody", sScrollFoot: "dataTables_scrollFoot", sScrollFootInner: "dataTables_scrollFootInner", sFooterTH: "" }; _oExt.oJUIClasses = { sPagePrevEnabled: "fg-button ui-button ui-state-default ui-corner-left", sPagePrevDisabled: "fg-button ui-button ui-state-default ui-corner-left ui-state-disabled", sPageNextEnabled: "fg-button ui-button ui-state-default ui-corner-right", sPageNextDisabled: "fg-button ui-button ui-state-default ui-corner-right ui-state-disabled", sPageJUINext: "ui-icon ui-icon-circle-arrow-e", sPageJUIPrev: "ui-icon ui-icon-circle-arrow-w", sPageButton: "fg-button ui-button ui-state-default", sPageButtonActive: "fg-button ui-button ui-state-default ui-state-disabled", sPageButtonStaticDisabled: "fg-button ui-button ui-state-default ui-state-disabled", sPageFirst: "first ui-corner-tl ui-corner-bl", sPagePrevious: "previous", sPageNext: "next", sPageLast: "last ui-corner-tr ui-corner-br", sStripOdd: "odd", sStripEven: "even", sRowEmpty: "dataTables_empty", sWrapper: "dataTables_wrapper", sFilter: "dataTables_filter", sInfo: "dataTables_info", sPaging: "dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_", sLength: "dataTables_length", sProcessing: "dataTables_processing", sSortAsc: "ui-state-default", sSortDesc: "ui-state-default", sSortable: "ui-state-default", sSortableAsc: "ui-state-default", sSortableDesc: "ui-state-default", sSortableNone: "ui-state-default", sSortColumn: "sorting_", sSortJUIAsc: "css_right ui-icon ui-icon-triangle-1-n", sSortJUIDesc: "css_right ui-icon ui-icon-triangle-1-s", sSortJUI: "css_right ui-icon ui-icon-carat-2-n-s", sSortJUIAscAllowed: "css_right ui-icon ui-icon-carat-1-n", sSortJUIDescAllowed: "css_right ui-icon ui-icon-carat-1-s", sSortJUIWrapper: "DataTables_sort_wrapper", sSortIcon: "DataTables_sort_icon", sScrollWrapper: "dataTables_scroll", sScrollHead: "dataTables_scrollHead ui-state-default", sScrollHeadInner: "dataTables_scrollHeadInner", sScrollBody: "dataTables_scrollBody", sScrollFoot: "dataTables_scrollFoot ui-state-default", sScrollFootInner: "dataTables_scrollFootInner", sFooterTH: "ui-state-default" }; _oExt.oPagination = { two_button: { fnInit: function (oSettings, nPaging, fnCallbackDraw) {
        ...
        if (!oSettings.aanFeatures.p) { return } var iPageCount = _oExt.oPagination.iFullNumbersShowPages; var iPageCountHalf = Math.floor(iPageCount / 2); var iPages = Math.ceil((oSettings.fnRecordsDisplay()) / oSettings._iDisplayLength); var iCurrentPage = Math.ceil(oSettings._iDisplayStart / oSettings._iDisplayLength) + 1; var sList = ""; var iStartButton, iEndButton, i, iLen; var oClasses = oSettings.oClasses; if (iPages < iPageCount) { iStartButton = 1; iEndButton = iPages } else {
            if (iCurrentPage <= iPageCountHalf) { iStartButton = 1; iEndButton = iPageCount } else {
        ...
        function classSettings() {
            ...
            if (oSettings.bAjaxDataGet) {
                _fnProcessingDisplay(oSettings, true); var iColumns = oSettings.aoColumns.length; var aoData = [], mDataProp; var i; oSettings.iDraw++; aoData.push({ name: "sEcho", value: oSettings.iDraw }); aoData.push({ name: "iColumns", value: iColumns }); aoData.push({ name: "sColumns", value: _fnColumnOrdering(oSettings) }); aoData.push({ name: "iDisplayStart", value: oSettings._iDisplayStart }); aoData.push({ name: "iDisplayLength", value: oSettings.oFeatures.bPaginate !== false ? oSettings._iDisplayLength : -1 }); for (i = 0; i < iColumns; i++) { mDataProp = oSettings.aoColumns[i].mDataProp; aoData.push({ name: "mDataProp_" + i, value: typeof (mDataProp) == "function" ? "function" : mDataProp }) } if (oSettings.oFeatures.bFilter !== false) {
                    ...
                    aoData.push({ name: "bRegex", value: oSettings.oPreviousSearch.bRegex }); for (i = 0; i < iColumns; i++) { aoData.push({ name: "sSearch_" + i, value: oSettings.aoPreSearchCols[i].sSearch }); aoData.push({ name: "bRegex_" + i, value: oSettings.aoPreSearchCols[i].bRegex }); aoData.push({ name: "bSearchable_" + i, value: oSettings.aoColumns[i].bSearchable }) } 
            ...
            var iOldStart = oSettings._iDisplayStart; if (sAction == "first") { oSettings._iDisplayStart = 0 } else {
                if (sAction == "previous") {
      ...
      k);
            ...
            , "click.uniform touchend.uniform": function (r) {
                if (a(r.target).is("span") || a(r.target).is("div")) {
                    if (o[0].dispatchEvent) {
                        var q = document.createEvent("MouseEvents"); q.initEvent("click",
                     true,
                     true); o[0].dispatchEvent(q)
                    }
                    else {
                        o[0].click()
                    }
        ...
        a.uniform.restore = function (l) {
            ...
            a(l).each(function () {
                ...
                a(this).unbind(".uniform"); a(this).css("opacity",
            "1"); var m = a.inArray(a(l),
            a.uniform.elements); a.uniform.elements.splice(m,
            1)
            }
         )
        };
...
(function (a) {
    a.extend(a.fn, {
        validate: function (b) {
            if (!this.length) {
                b && b.debug && window.console && console.warn("nothing selected, can't validate, returning nothing"); return
            }
            var c = a.data(this[0],
         "validator"); if (c) {
                return c
            ...
            c = new a.validator(b,
         this[0]); a.data(this[0],
         "validator",
         c); if (c.settings.onsubmit) {
                ...
                this.submit(function (d) {
                    ...
                    function e() {
                        if (c.settings.submitHandler) {
                            if (c.submitButton) {
                                var f = a("<input type='hidden'/>").attr("name",
                        c.submitButton.name).val(c.submitButton.value).appendTo(c.currentForm)
                            }
                            c.settings.submitHandler.call(c,
                     c.currentForm); if (c.submitButton) {
                                f.remove()
                            }
                            return false
                        }
                    ...
                    if (c.cancelSubmit) {
                        c.cancelSubmit = false; return e()
                    }
                    if (c.form()) {
                        if (c.pendingRequest) {
                            c.formSubmitted = true; return false
                        }
                        return e()
                    }
                    else {
                        c.focusInvalid(); return false
                    }
                }
            )
            }
      ...
      , valid: function () {
          if (a(this[0]).is("form")) {
              ...
              var c = true; var b = a(this[0].form).validate(); this.each(function () {
                  c &= b.element(this)
              }
            ); return c
          }
...
(function (a) {
    a.fn.visualize = function (c, b) {
        return a(this).each(function () {
            var s = a.extend({ type: "bar", width: a(this).width(), height: a(this).height(), appendTitle: true, title: null, appendKey: true, rowFilter: " ", colFilter: " ", colors: ["#be1e2d", "#666699", "#92d5ea", "#ee8310", "#8d10ee", "#5a3b16", "#26a4ed", "#f45a90", "#e9e744"], textColors: [], parseDirection: "x", pieMargin: 20, pieLabelsAsPercent: true, pieLabelPos: "inside", lineWeight: 4, barGroupMargin: 10, barMargin: 1, yLabelInterval: 30 }, c); s.width = parseFloat(s.width); s.height = parseFloat(s.height); var r = a(this); function A() { var o = s.colors; var C = s.textColors; var B = { dataGroups: function () { var D = []; if (s.parseDirection == "x") { r.find("tr:gt(0)").filter(s.rowFilter).each(function (G) { D[G] = {}; D[G].points = []; D[G].color = o[G]; if (C[G]) { D[G].textColor = C[G] } a(this).find("td").filter(s.colFilter).each(function () { D[G].points.push(parseFloat(a(this).text())) }) }) } else { var F = r.find("tr:eq(1) td").filter(s.colFilter).size(); for (var E = 0; E < F; E++) { D[E] = {}; D[E].points = []; D[E].color = o[E]; if (C[E]) { D[E].textColor = C[E] } r.find("tr:gt(0)").filter(s.rowFilter).each(function () { D[E].points.push(a(this).find("td").filter(s.colFilter).eq(E).text() * 1) }) } } return D }, allData: function () { var D = []; a(this.dataGroups()).each(function () { D.push(this.points) }); return D }, dataSum: function () { var E = 0; var D = this.allData().join(",").split(","); a(D).each(function () { E += parseFloat(this) }); return E }, topValue: function () { var E = 0; var D = this.allData().join(",").split(","); a(D).each(function () { if (parseFloat(this, 10) > E) { E = parseFloat(this) } }); return E }, bottomValue: function () { var E = 0; var D = this.allData().join(",").split(","); a(D).each(function () { if (this < E) { E = parseFloat(this) } }); return E }, memberTotals: function () { var E = []; var D = this.dataGroups(); a(D).each(function (F) { var G = 0; a(D[F].points).each(function (H) { G += D[F].points[H] }); E.push(G) }); return E }, yTotals: function () { var G = []; var E = this.dataGroups(); var H = this.xLabels().length; for (var F = 0; F < H; F++) { G[F] = []; var D = 0; a(E).each(function (I) { G[F].push(this.points[F]) }); G[F].join(",").split(","); a(G[F]).each(function () { D += parseFloat(this) }); G[F] = D } return G }, topYtotal: function () { var D = 0; var E = this.yTotals().join(",").split(","); a(E).each(function () { if (parseFloat(this, 10) > D) { D = parseFloat(this) } }); return D }, totalYRange: function () { return this.topValue() - this.bottomValue() }, xLabels: function () { var D = []; if (s.parseDirection == "x") { r.find("tr:eq(0) th").filter(s.colFilter).each(function () { D.push(a(this).html()) }) } else { r.find("tr:gt(0) th").filter(s.rowFilter).each(function () { D.push(a(this).html()) }) } return D }, yLabels: function () { var F = []; F.push(j); var E = Math.round(s.height / s.yLabelInterval); var D = Math.ceil(d / E) || 1; while (F[F.length - 1] < p - D) { F.push(F[F.length - 1] + D) } F.push(p); return F } }; return B } var x = { pie: function () { l.addClass("visualize-pie"); if (s.pieLabelPos == "outside") { l.addClass("visualize-pie-outside") } var E = Math.round(h.width() / 2); var D = Math.round(h.height() / 2); var o = D - s.pieMargin; var B = 0; var C = function (G) { return (Math.PI / 180) * G }; var F = a('<ul class="visualize-labels"></ul>').insertAfter(h); a.each(n, function (L) { var Q = (this <= 0 || isNaN(this)) ? 0 : this / m; t.beginPath(); t.moveTo(E, D); t.arc(E, D, o, B * Math.PI * 2 - Math.PI * 0.5, (B + Q) * Math.PI * 2 - Math.PI * 0.5, false); t.lineTo(E, D); t.closePath(); t.fillStyle = e[L].color; t.fill(); var O = (B + Q / 2); var G = s.pieLabelPos == "inside" ? o / 1.5 : o + o / 5; var K = Math.round(E + Math.sin(O * Math.PI * 2) * (G)); var J = Math.round(D - Math.cos(O * Math.PI * 2) * (G)); var H = (K > E) ? "right" : "left"; var I = (J > D) ? "bottom" : "top"; var R = parseFloat((Q * 100).toFixed(2)); if (R) { var M = (s.pieLabelsAsPercent) ? R + "%" : this; var P = a('<span class="visualize-label">' + M + "</span>").css(H, 0).css(I, 0); if (P) { var N = a('<li class="visualize-label-pos"></li>').appendTo(F).css({ left: K, top: J }).append(P) } P.css("font-size", o / 8).css("margin-" + H, -P.width() / 2).css("margin-" + I, -P.outerHeight() / 2); if (e[L].textColor) { P.css("color", e[L].textColor) } } B += Q }) }, line: function (E) {
                if (E) { l.addClass("visualize-area") } else { l.addClass("visualize-line") } var F = h.width() / (q.length - 1); var C = a('<ul class="visualize-labels-x"></ul>').width(h.width()).height(h.height()).insertBefore(h);
                a.each(q, function (I) { var G = a("<li><span>" + this + "</span></li>").prepend('<span class="line" />').css("left", F * I).appendTo(C); var H = G.find("span:not(.line)"); var J = H.width() / -2; if (I == 0) { J = 0 } else { if (I == q.length - 1) { J = -H.width() } } H.css("margin-left", J).addClass("label") }); var D = h.height() / d; var o = h.height() / (y.length - 1); var B = a('<ul class="visualize-labels-y"></ul>').width(h.width()).height(h.height()).insertBefore(h); a.each(y, function (J) { var G = a("<li><span>" + this + "</span></li>").prepend('<span class="line"  />').css("bottom", o * J).prependTo(B); var H = G.find("span:not(.line)"); var I = H.height() / -2; if (J == 0) { I = -H.height() } else { if (J == y.length - 1) { I = 0 } } H.css("margin-top", I).addClass("label") }); t.translate(0, f); a.each(e, function (I) { t.beginPath(); t.lineWidth = s.lineWeight; t.lineJoin = "round"; var H = this.points; var G = 0; t.moveTo(0, -(H[0] * D)); a.each(H, function () { t.lineTo(G, -(this * D)); G += F }); t.strokeStyle = this.color; t.stroke(); if (E) { t.lineTo(G, 0); t.lineTo(0, 0); t.closePath(); t.fillStyle = this.color; t.globalAlpha = 0.3; t.fill(); t.globalAlpha = 1 } else { t.closePath() } })
            ...
            }; var k = document.createElement("canvas"); k.setAttribute("height", s.height); k.setAttribute("width", s.width); var h = a(k); var z = s.title || r.find("caption").text(); var l = (b || a('<div class="visualize" role="img" aria-label="Chart representing data from the table: ' + z + '" />')).height(s.height).width(s.width).append(h); var g = A(); var e = g.dataGroups(); var w = g.allData(); var m = g.dataSum(); var p = g.topValue(); var j = g.bottomValue(); var n = g.memberTotals(); var d = g.totalYRange(); var f = s.height * (p / d); var q = g.xLabels(); var y = g.yLabels(); if (s.appendTitle || s.appendKey) { var i = a('<div class="visualize-info"></div>').appendTo(l) } if (s.appendTitle) { a('<div class="visualize-title">' + z + "</div>").appendTo(i) } if (s.appendKey) { var v = a('<ul class="visualize-key"></ul>'); var u; if (s.parseDirection == "x") { u = r.find("tr:gt(0) th").filter(s.rowFilter) } else { u = r.find("tr:eq(0) th").filter(s.colFilter) } u.each(function (o) { a('<li><span class="visualize-key-color" style="background: ' + e[o].color + '"></span><span class="visualize-key-label">' + a(this).text() + "</span></li>").appendTo(v) }); v.appendTo(i) } if (!b) { l.insertAfter(this) } if (typeof (G_vmlCanvasManager) != "undefined") { G_vmlCanvasManager.init(); G_vmlCanvasManager.initElement(h[0]) } var t = h[0].getContext("2d"); x[s.type](); a(".visualize-line li:first-child span.line, .visualize-line li:last-child span.line, .visualize-area li:first-child span.line, .visualize-area li:last-child span.line, .visualize-bar li:first-child span.line,.visualize-bar .visualize-labels-y li:last-child span.line").css("border", "none"); if (!b) { l.bind("visualizeRefresh", function () { r.visualize(s, a(this).empty()) }) } 
        }).next()
    } 
})(jQuery); 
jQuery.fn.initMenu = function () { 
return this.each(function () { var a = $(this).get(0); $("li:has(ul)", this).each(function () { $(">a", this).append("<span class='arrow'></span>") }); $(".sub", this).hide(); $("li.expand > .sub", this).show(); $("li.expand > .sub", this).prev().addClass("active"); $("li a", this).click(function (d) { d.stopImmediatePropagation(); var c = $(this).next(); var b = this.parentNode.parentNode; if ($(this).hasClass("active-icon")) { $(this).addClass("non-active-icon"); $(this).removeClass("active-icon") } else { $(this).addClass("active-icon"); $(this).removeClass("non-active-icon") } if ($(b).hasClass("noaccordion")) { if (c[0] === undefined) { window.location.href = this.href } $(c).slideToggle("normal", function () { if ($(this).is(":visible")) { $(this).prev().addClass("active") } else { $(this).prev().removeClass("active"); $(this).prev().removeClass("active-icon") } }); return false } else { if (c.hasClass("sub") && c.is(":visible")) { if ($(b).hasClass("collapsible")) { $(".sub:visible", b).first().slideUp("normal", function () { $(this).prev().removeClass("active"); $(this).prev().removeClass("active-icon") }); return false } return false } if (c.hasClass("sub") && !c.is(":visible")) { $(".sub:visible", b).first().slideUp("normal", function () { $(this).prev().removeClass("active"); $(this).prev().removeClass("active-icon") }); c.slideDown("normal", function () { $(this).prev().addClass("active") }); return false } } }) }) }; (function (a) { a.fn.slideList = function (b) { return a(this).each(function () { var d = a(this).css("padding-left"); var c = a(this).css("padding-right"); a(this).hover(function () { a(this).animate({ paddingLeft: parseInt(d) + parseInt(5) + "px" }, 130) }, function () { bc_hover = a(this).css("background-color"); a(this).animate({ paddingLeft: d, paddingRight: c }, 130) }) }) } })(jQuery); (function (a) { a.fn.alertBox = function (d, b) { var c = a.extend({}, a.fn.alertBox.defaults, b); this.each(function (f) { var j = a(this); var e = "alert " + c.type; if (c.noMargin) { e += " no-margin" } if (c.position) { e += " top" } var h = '<div id="alertBox-generated" style="display:none" class="' + e + '">' + d + "</div>"; var g = j.prepend(h); a("#alertBox-generated").fadeIn() }) }; a.fn.alertBox.defaults = { type: "info", position: "top", noMargin: true} })(jQuery); (function (a) { a.fn.removeAlertBoxes = function (d, c) { var e = a(this); var b = e.find(".alert"); b.remove() } })(jQuery); $("[placeholder]").focus(function () { var a = $(this); if (a.val() == a.attr("placeholder")) { a.val(""); a.removeClass("placeholder") } }).blur(function () { var a = $(this); if (a.val() == "" || a.val() == a.attr("placeholder")) { a.addClass("placeholder"); a.val(a.attr("placeholder")) } }).blur().parents("form").submit(function () { $(this).find("[placeholder]").each(function () { var a = $(this); if (a.val() == a.attr("placeholder")) { a.val("") } }) }); $.fn.resetForm = function () { $(this).removeAlertBoxes(); return this.each(function () { if (typeof this.reset == "function" || (typeof this.reset == "object" && !this.reset.nodeType)) { this.reset() } }) }; (function (a) { a.fn.createTabs = function () { var b = a(this); b.find(".tab-content").hide(); b.find("ul.tabs li:first").addClass("active").show(); b.find(".tab-content:first").show(); b.find("ul.tabs li").click(function () { b.find("ul.tabs li").removeClass("active"); a(this).addClass("active"); b.find(".tab-content").hide(); var c = a(this).find("a").attr("href"); a(c).fadeIn(); return false }) } })(jQuery); window.log = function () { log.history = log.history || []; log.history.push(arguments); if (this.console) { arguments.callee = arguments.callee.caller; var a = [].slice.call(arguments); (typeof console.log === "object" ? log.apply.call(console.log, console, a) : console.log.apply(console, a)) } }; (function (e) { function h() { } for (var g = "assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,timeStamp,profile,profileEnd,time,timeEnd,trace,warn".split(","), f; f = g.pop(); ) { e[f] = e[f] || h } })((function () { try { console.log(); return window.console } catch (a) { return window.console = {} } })()); $(document).ready(function () { $(".menu").initMenu(); $(".menu li a").slideList(); $("a[href*=#]").bind("click", function (b) { b.preventDefault(); var c = $(this).attr("href"); if (c == "#top") { $.jGrowl("Scrolling to the top.", { theme: "information" }) } $("html,body").animate({ scrollTop: $(c).offset().top }, 1000, function () { }) }); $("span.hide").click(function () { $(this).parent().slideUp() }); $(".toolbox-action").click(function () { $(".toolbox-content").fadeOut(); $(this).next().fadeIn(); return false }); $(".close-toolbox").click(function () { $(this).parents(".toolbox-content").fadeOut() }); $(".user-button").click(function () { $(".dropdown-username-menu").slideToggle() }); $(document).click(function (b) { if (!$(b.target).is(".user-button, .arrow-link-down, .dropdown-username-menu *")) { $(".dropdown-username-menu").slideUp() } }); var a; $(".user-button, ul.dropdown-username-menu").mouseleave(function (b) { a = setTimeout(function () { $(".dropdown-username-menu").slideUp() }, 400) }); $(".user-button, ul.dropdown-username-menu").mouseenter(function (b) { clearTimeout(a) }); $(".block-border .block-header span").click(function () { if ($(this).hasClass("closed")) { $(this).removeClass("closed") } else { $(this).addClass("closed") } $(this).parent().parent().children(".block-content").slideToggle() }); $("a[rel=tooltip]").tipsy({ fade: true }); $("a[rel=tooltip-bottom]").tipsy({ fade: true }); $("a[rel=tooltip-right]").tipsy({ fade: true, gravity: "w" }); $("a[rel=tooltip-top]").tipsy({ fade: true, gravity: "s" }); $("a[rel=tooltip-left]").tipsy({ fade: true, gravity: "e" }); $("a[rel=tooltip-html]").tipsy({ fade: true, html: true }); $("div[rel=tooltip]").tipsy({ fade: true }) });
...
//    $('#graph-data').visualize({ type: 'pie', height: 250 }).appendTo('#tab-pie').trigger('visualizeRefresh'); $('#graph-data').visualize({ type: 'bar', height: 250 }).appendTo('#tab-bar').trigger('visualizeRefresh');
