...
public class GooglePoint
{
    ...
    public GooglePoint(string pID, string plat, string plon, string picon, string pinfohtml)
    {
        ID = pID;
        Latitude = plat;
        Longitude = plon;
    ...
    public GooglePoint(string pID, string plat, string plon, string picon, string pinfohtml, string pTooltipText, bool pDraggable)
    {
        ID = pID;
        Latitude = plat;
        Longitude = plon;
    ...
    public GooglePoint(string pID, string plat, string plon, string picon)
    {
        ID = pID;
        Latitude = plat;
        Longitude = plon;
    ...
    public GooglePoint(string pID, string plat, string plon)
    {
        ID = pID;
        Latitude = plat;
        Longitude = plon;
