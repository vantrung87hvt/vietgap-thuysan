<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucDoituongnuoiManager.ascx.cs" Inherits="adminx_ucDoituongnuoiManager" %>
<link href="../CSS/Grid_View.css" rel="stylesheet" type="text/css" />

<h2>
Quản Lý Thông Tin Đối tượng nuôi
</h2>
...
<asp:Panel ID="pnAdd" runat="server" Visible="false" >
    ...
    <div class="m">
        <fieldset>
            <legend>Thông tin đối tượng nuôi</legend>
            <div class="a">
                <div class="l">
