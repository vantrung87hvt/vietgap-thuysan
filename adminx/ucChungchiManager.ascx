<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucChungchiManager.ascx.cs"
    Inherits="adminx_Tochucchungnhan_ucChungchiChuyengia" %>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td valign="middle" width="70%">
                            <asp:TextBox ID="txtChungchi" runat="server" Width="95%" Height="22px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rqTenChungchi" runat="server" ControlToValidate="txtChungchi"
                                ErrorMessage="*" ValidationGroup="vgGroup"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="20%">
                            <asp:Label ID="Label2" runat="server" Text="<%$Resources:language,lblMota %>"></asp:Label>
                        </td>
                        <td valign="middle" width="70%">
