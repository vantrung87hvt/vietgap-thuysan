<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucFAQManager.ascx.cs" Inherits="INVI.INVINews.Admin.DocumentManager" %>
 ...
 <div class="field100Pct">
  ...
  <div class="fieldItemValue">
      <asp:TextBox ID="txtCauhoi" runat="server" TextMode="MultiLine" 
        ...
        <asp:RequiredFieldValidator ID="rfvCauhoi" runat="server" 
