<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucUserManager.ascx.cs" Inherits="adminx_ucUserManager" %>
        ...
        <td>
            <table width="100%">
                ...
                <tr>
                    ...
                    <td width="80%"><asp:DropDownList ID="ddlGroupName" runat="server" 
...
<AlternatingRowStyle CssClass="GridAltItem"></AlternatingRowStyle>
    <Columns>
      <asp:TemplateField HeaderText="Chọn tất">
        ...
        <asp:TemplateField HeaderText="Kích hoạt" SortExpression="bActive">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("bActive") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="lblKichhoat" runat="server" Text='<%# Bind("bActive") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
