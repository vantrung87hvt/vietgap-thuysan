<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucPollManager.ascx.cs" Inherits="INVI.INVINews.Admin.PollManager" %>

<%@ Register src="~/adminx/ucAnswerManager.ascx" tagname="AnswerManager" tagprefix="uc1" %>
