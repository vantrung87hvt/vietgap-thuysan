<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewGisMap.aspx.cs" Inherits="NewGisMap" %>
    ...
    <table> 
        <tr style="vertical-align: top">
            <td style="width: 15em">
                ...
                <p>
                    To draw on the map, click on one of the buttons and then click on the map. Double-click
                    to stop drawing a line or shape. Click on an element to change color. To edit a
                    line or shape, mouse over it and drag the points. Click on a point to delete it.
                </p>
            ...
            <td>
                ...
                <div id="map" style="width: 640px; height: 400px">
                </div>
            </td>
        </tr>
    </table>
