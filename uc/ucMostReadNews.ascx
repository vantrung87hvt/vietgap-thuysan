<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucMostReadNews.ascx.cs" Inherits="uc_ucMostReadNews" %>
<style>
   .post h2
{
    margin-left:0;
...
<asp:Repeater ID="rptrNewsInHome" runat="server" 
    ...
    <ItemTemplate>                    
            <div class="post">
                    ...
                    <div  class ="mostbody" style="float:left;width:315px; margin-left:10px;">
					<h4>
